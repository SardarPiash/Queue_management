...
export default function RegisterAdminBySAdmin() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/admin/registration',
                {
            ...
            } else if (response.data.message == "Admin table registration failed") {
                setSuccess("");
                setError(<span>Admin registration failed<br />server side error</span>);
            } else {
                setError("");
                setSuccess("Admin Registered Successfully");
                reset();
                setTimeout(() => {
                    router.push('/superadmin/all_admin');
                }, 2000);
            }
        } catch (error) {
            console.error(error);
    ...
    return (
        <>
            ...
            <Layout title="Admin Registration - Medical Service">
