                        ...
                        <>
                            {
                                user === 'patient' ? (
                                    <div className='flex md:flex-row flex-col md:justify-evenly justify-center items-center md:gap-10 gap-4'>
                                        <Link href="/patient/dashboard" className="text-gray-900 hover:text-indigo-700 transition duration-200">Dashboard</Link>
                                        <Link href="/patient/viewAppoinment" className="text-gray-900 hover:text-indigo-700 transition duration-200">View Appointment</Link>
                                            ...
                                            {clicked && (
                                                <>
                                                    ...
                                                    <div className="flex flex-col justify-center items-start absolute px-5 py-5 z-[5] top-[30px] right-[8px] rounded-[8px] bg-slate-50 h-fit w-[180px] font-[500] text-gray-900 shadow-lg shadow-gray-300 space-y-4">
                                                        <Link href="/patient/viewProfile" className="text-[15px] hover:text-indigo-700 transition duration-200">Profile</Link>
                                        ...
                                        <>
                                            {
                                                user === 'superadmin' ? (
                                                    <div className='flex md:flex-row flex-col md:justify-evenly justify-center items-center md:gap-10 gap-4'>
                                                        <Link href="/superadmin" className="text-gray-900 hover:text-indigo-700 transition duration-200">Dashboard</Link>
                                                        <Link href="/superadmin/all_admin" className="text-gray-900 hover:text-indigo-700 transition duration-200">Admins</Link>
                                                        <Link href="/superadmin/all_hospital" className="text-gray-900 hover:text-indigo-700 transition duration-200">Hospitals</Link>
                                                        <Link href="/superadmin/all_doctor" className="text-gray-900 hover:text-indigo-700 transition duration-200">Doctors</Link>
                                                        <Link href="/superadmin/all_patient" className="text-gray-900 hover:text-indigo-700 transition duration-200">Patients</Link>
                                                        <div className="relative flex">
                                                            <button className="flex justify-center group" onClick={handleMouseClick}>
                                                                <UserCircleIcon className="h-6 w-6 text-gray-900 hover:text-indigo-700 transition duration-300" />
                                                            </button>
